...
def reset_glue_job_bookmark(
    team: str, project: str, platform: str, schema: str, tables: list
):
    """
...
def run_glue_job(
    ...
    for table in tables:
        ...
        logger.info(
            f"The Glue Job '{job_id}' for the Job name '{job_name}' started successfully"
        )
