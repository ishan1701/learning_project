...
class Vacation:
    def __init__(self, start_date: date, end_date: date, flatmate_id: int, apt_id: int, apt_room_id: int):
    ...
    def from_date(cls, **kwargs):
        return cls(start_date=kwargs['start_date'], end_date=kwargs['end_date'], flatmate_id=kwargs['flatmate_id'],
