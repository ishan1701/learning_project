...
class GamingComputerBuilder(ComputerBuilder):
    ...
    def assemble_memory(self, memory: RAM) -> Self:
        self.memory = memory
        return self

    def assemble_processing_unit(self, processing_unit: CPU) -> Self:
        self.processing_unit = processing_unit
        return self

    def assemble_storage(self, storage: Storage) -> Self:
        self.storage = storage

    def assemble_graphics_card_memory(self, graphics_card_memory: int) -> Self:
