...
class Accountant(Employee):
    ...
    def __init__(
        self, name: str, salary: float, manager: "Manager", is_passed_accounts: bool
    ):
...
class Salesman(Employee):
    ...
    def __init__(
        self, name: str, salary: float, manager: "Manager", is_passed_salesmanship: bool
    ):
        super().__init__(name=name, salary=salary, manager=manager)
...
class Manager(Employee, ABC):
    ...
    def __init__(
        ...
        salary: float,
        manager: "Manager",
        reporting_employee: list[Employee],
    ):
...
class SalesManager(Manager, Salesman):
    ...
    def __init__(
        ...
        Manager.__init__(
            ...
            salary=salary,
            manager=manager,
            reporting_employee=reporting_employee,
        )
        Salesman.__init__(
            self,
            name=name,
...
if __name__ == "__main__":
    s_m = EmployeeFactory.create_employee(
        "sales_manager",
        name="Charlie",
        salary=80000,
        manager=None,
        reporting_employee=[],
        is_passed_salesmanship=True,
        is_masters=True,
    )

    s_m1 = EmployeeFactory.create_employee(
        "sales_manager",
        name="Charlie",
        salary=80000,
        manager=None,
    ...
    s_mman = EmployeeFactory.create_employee(
        "salesman",
        name="Charlie",
        salary=80000,
        manager=None,
