...
from text_formatter import TextFormatterTypeMap, TextFormatter
...
if __name__ == '__main__':
    ...
    with open(Path(__file__).parent.parent.joinpath('data', 'output.txt'), 'w+') as f_write:
        for content in contents:
            output_line: str = str()
            format_type = _random_text_type()
            text_formatter = TextFormatterStrategyFactory.formatter(formatter_type=format_type)
